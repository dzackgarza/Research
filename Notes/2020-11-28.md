...
If $f: a\to b$ is a 1-simpliex in an $\infty\dash$category $\mathcal{C}$, then we say $f$ is an **equivalence** if there exists a 1-simplex $g:b\to a$ such that $\id_a \homotopic g\circ f$ and $\id_b \homotopic f\circ g$.
:::
