...
For 1-simplices $f: a\to b, g:b\to c$, a **composition** of $f$ and $g$ is a 2-simplex
\begin{tikzcd}
	&& {b} \\
	\\
	{a} &&&& {c}
	...
	\arrow[""{name=0, inner sep=0}, from=3-1, to=3-5]
	\arrow[Rightarrow, from=0, to=1-3, shorten <=6pt, shorten >=6pt]
\end{tikzcd}
