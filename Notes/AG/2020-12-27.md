...
There is a nice universal property here, namely that functors out of $\mathrm{sAlg}_k$ are functors out of $\mathrm{CAlg}_k^{\text{poly}}$ that satisfying some additional properties.
