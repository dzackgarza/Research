...
Consider the derived category $\mathcal{C} \da D(\ZZ)_{\geq 0}$ and its connective objects, which are chain complexes $C_\wait$ where $H_{< 0}(C_\wait) = 0$.
...
This is not necessarily a symmetric monoidal abelian category, but 
