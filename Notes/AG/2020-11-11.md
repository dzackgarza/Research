# Cotangent Complex and Derived de Rham Cohomology
...
1. $\ssets \homotopic \Top$: this is not an equivalence of categories, but rather they equivalent homotopy theories (theory up to weak equivalence).
...
If you make a function $\Delta^n \mapstofrom \Delta^n_{\text{Top}}$, then by Yoneda the presheaf category $\Presh(\Delta) \da \Fun(\Delta^1, \set)$ is generated by representable objects.
  ...
  So the notion of weak equivalence on the $\\$ is just given by pullback along this functor.
